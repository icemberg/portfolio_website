...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        exp1.setDuration("Feb 2025 – Mar 2025");
        exp1.setDescription("Architected Spring Boot microservices for Stripe payment processing, implementing full REST API lifecycle including webhook handling, idempotency, and error recovery; secured endpoints using Spring Security with JWT, OAuth2, and HmacSHA256 signature verification.");
        ...
        exp2.setDuration("Feb 2025 – Present");
        exp2.setDescription("Designing and training machine learning models for Electric Vehicle performance optimization and predictive analytics using Python and scikit-learn.");
        ...
        skills.add(createSkill("Backend & Frameworks", "Spring Boot, Spring Security, Spring Data JPA, Hibernate, REST, Microservices, Maven"));
        skills.add(createSkill("AI / ML", "scikit-learn, NumPy, Pandas, T5 Transformer, spaCy, Vector Embeddings, RAG"));
